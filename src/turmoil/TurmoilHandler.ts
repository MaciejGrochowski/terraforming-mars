...
import {KELVINISTS_POLICY_1, KELVINISTS_POLICY_3, KELVINISTS_POLICY_4, KELVINISTS_POLICY_5} from './parties/Kelvinists';
...
import {SCIENTISTS_POLICY_1, SCIENTISTS_POLICY_5} from './parties/Scientists';
...
export class TurmoilHandler {
  ...
  public static addPlayerAction(player: Player, options: PlayerInput[]): void {
    ...
    if (PartyHooks.shouldApplyPolicy(player.game, PartyName.SCIENTISTS, TurmoilPolicy.SCIENTISTS_POLICY_5)) {
      const scientistsPolicy = SCIENTISTS_POLICY_5;
    ...
    if (PartyHooks.shouldApplyPolicy(player.game, PartyName.KELVINISTS, TurmoilPolicy.KELVINISTS_POLICY_5)) {
      const kelvinistsPolicy = KELVINISTS_POLICY_5;
