...
import {GREENS_POLICY_1, GREENS_POLICY_5} from './Greens';
...
export class PartyHooks {
  ...
  static applyGreensRulingPolicy(player: Player, space: ISpace) {
    ...
    if (this.shouldApplyPolicy(player.game, PartyName.GREENS, TurmoilPolicy.GREENS_POLICY_5)) {
      const greensPolicy = GREENS_POLICY_5;
      greensPolicy.onTilePlaced(player, space);
    }
  }
